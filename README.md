...
Adjacent validation calls on that same local builder may appear before or after the bind statement. The scan stops at unrelated statements instead of guessing across wider control flow.
