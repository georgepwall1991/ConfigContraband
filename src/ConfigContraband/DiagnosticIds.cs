...
{
    public const string MissingConfigurationSection = "CFG001";
    public const string MissingRequiredConfigurationKey = "CFG002";
    public const string ValidationNotOnStart = "CFG003";
